...
/**
 * A class for storing the dates and times for the start and end of an event. If
 * any of start time, end time, or end date are not set then they may be given
 * default values.
 * 
 * @author wginsberg
 *
...
public class EventTime {
	...
	protected transient Date startDate = null;
	protected transient Date endDate = null;
	...
	public EventTime(String start_date, String end_date, String start_time, String end_time) {
		...
		if (dateFormat == null) {
			dateFormat = new SimpleDateFormat("d/M/yyy h:mm a");
		}
	}
