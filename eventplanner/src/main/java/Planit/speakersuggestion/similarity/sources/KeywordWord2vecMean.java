 ...
 *
 */
public class KeywordWord2vecMean extends Source<ComparisonRequest, Double, Void> implements SimilarityContractDouble {
	...
	public Opinion<Double, Void> getOpinion(ComparisonRequest args)
		...
		try {
			...
			double max = MatrixUtil.mean(similarityMatrix);
