...
public class demo {
	...
	static private String fileRealEvents = "./data/event data/fabricated-plausible-events.json";
	static private String fileFakeEvents = "./data/event data/fabricated-inplausible-events.json";
	...
	static private String outFilePath = "./data/chillwall-versus-fabricated-2.0.arff";
